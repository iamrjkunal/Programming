...
int main(int argc, char **argv)
{
   ...
   FILE *fp;
   int ctr, num_transactions, special_case = 0, prev_was_spe = 0;
  ...
  for(ctr=0; ctr<num_transactions; ++ctr){
     ...
     if (special_case) {
       ...
       t.ac1 = t.ac2;
       t.ac2 = temp_a;
       printf("special case on trans[%d] for acc[%d and %d]\n", t.seq, t.ac1, t.ac2);
       special_case = 0;
       prev_was_spe = 1;//!prev_was_spe;
     } else {
       t.type = 1 + random() % TRANSFER;
       t.ac1 = 1001 + (random() % 100);
       ac1 = t.ac1 - 1001;
       if(t.type == TRANSFER){
          do{
            t.ac2 = 1001 + (random() % 100);
            ac2 = t.ac2 - 1001;
          }while(t.ac1 == t.ac2);
       }else{
          t.ac2 = 0;
     ...
     case TRANSFER:
     {
       ...
       if(t.ac2) { /*TRANSFER*/
          ...
          if (drand48() < 0.0005f + prev_was_spe*0.5f) {
             special_case = 1;
          }
          prev_was_spe = 0;
       }
